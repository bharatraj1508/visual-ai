  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        {/* Balance hero */}
        <div className="mb-10 flex flex-col items-start justify-between gap-4 rounded-3xl border border-gray-100 bg-white p-7 shadow-sm sm:flex-row sm:items-center">
          <div>
