      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <motion.div {...reveal} variants={stagger} className="max-w-2xl">
          ...
          <motion.p variants={fadeUp} className="mt-4 text-lg text-gray-500">
            ...
            not whichever one is easiest to draw.
          </motion.p>
        </motion.div>
        ...
        >
          {CHARTS.map((c) => (
            <motion.div
              ...
              variants={fadeUp}
              whileHover={{ y: -4 }}
              className="group flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3.5 transition-colors hover:border-primary/30 hover:shadow-md hover:shadow-primary/5"
            >
